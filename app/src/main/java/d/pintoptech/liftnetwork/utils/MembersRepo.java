...
public class MembersRepo {
    private String sort, id, email, phone, name, helped, address, city, state, country,
            age, views, about, status, passport1, passport2, passport3, help_with, gender, category, occupation, helping_with;

    public MembersRepo(String sort, String id, String email, String phone, String name, String helped, String address, String city, String state, String country, String age,
                       String views, String about, String status, String passport1, String passport2, String passport3, String help_with, String gender, String category, String occupation,
                       String helping_with) {
        this.sort = sort;
        this.id = id;
        this.email = email;
        ...
        this.helping_with = helping_with;
    }
    ...
    public String getHelping_with() {
        return helping_with;
    }

    public void setHelping_with(String helping_with) {
        this.helping_with = helping_with;
    }
}
